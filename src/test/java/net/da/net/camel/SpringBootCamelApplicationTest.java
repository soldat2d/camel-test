...
public class SpringBootCamelApplicationTest {
    ...
    public void should_returnDiscounts() {
        NotifyBuilder notify = new NotifyBuilder(camelContext)
                ...
                .whenDone(1)
                .create();
        assertThat(notify.matches()).isTrue();

        ResponseEntity<Discount> response = restTemplate
                .getForEntity("/camel/products/discounts/1", Discount.class);
    ...
    public void should_returnProducts() {
        ResponseEntity<List<Product>> response = restTemplate.exchange("/camel/products",
